...
func main() {
	...
	// We create a message to be sent to the queue. It has to be an instance of the aqmp publishing struct
	...
	// The channel is not a rabbitMQ channel but a go channel
